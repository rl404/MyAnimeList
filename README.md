...
```css
@\import "https://cdn.jsdelivr.net/gh/rl404/MyAnimeList@master/Saber/main.css";
```
...
* **Hestia theme**:
```css
@\import "https://cdn.jsdelivr.net/gh/rl404/MyAnimeList@master/Danmachi/mainhestia.css";
```
* **Lili theme**:
```css
@\import "https://cdn.jsdelivr.net/gh/rl404/MyAnimeList@master/Danmachi/mainlili.css";
```
* **Ais theme**:
```css
@\import "https://cdn.jsdelivr.net/gh/rl404/MyAnimeList@master/Danmachi/mainais.css";
```
...
**How to use (for anime and manga)**:
```css
@\import "https://cdn.jsdelivr.net/gh/rl404/MyAnimeList@master/NierAutomata/main.css";
```
